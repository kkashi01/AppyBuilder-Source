...
// Context menus.
   ...
   "</p><p>If you leave AppyBuilder with blocks left in your backpack, " +
   " they will be there the next time you login." +
   "</p><p>For further documentation and a 'how to' video, see:" +
   '</p><p><a href="http://help.AppyBuilder.com" target="_blank">http://help.AppyBuilder.cocm</a>';
...
// Control Blocks
    ...
    Blockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_WITH_PLAIN_TEXT_TOOLTIP = 'Closes the current screen and returns text to the app that '
        + 'opened this one.   This command is for returning text to non-AppyBuilder activities, not to AppyBuilder screens. '
        + 'For AppyBuilder Screens, as in multiple screen apps, use Close Screen with Value, not Close Screen with Plain Text.';
...
// Messages from replmgr.js
    ...
    Blockly.Msg.REPL_COMPANION_OUT_OF_DATE1 = "The Companion you are using is out of date.<br/><br/>This Version of AppyBuilder should be used with Companion version";
    Blockly.Msg.REPL_COMPANION_OUT_OF_DATE_IMMEDIATE = "You are using an out-of-date Companion. You should update the AppyBuilder Companion as soon as possible. If you have auto-update setup in the store, the update will happen by itself shortly.";
    Blockly.Msg.REPL_COMPANION_WRONG_PACKAGE = "The Companion you are using was built for different instance of AppyBuilder. To obtain the correct companion look on the AppyBuilder screen under Help->Companion Information menu.";
    ...
    Blockly.Msg.REPL_UNABLE_TO_LOAD = "Unable to load update from AppyBuilder server";
    Blockly.Msg.REPL_UNABLE_TO_LOAD_NO_RESPOND = "Unable to load update from AppyBuilder server (server not responding)";
    Blockly.Msg.REPL_NOW_DOWNLOADING = "We are now downloading update from the AppyBuilder Server, please standby";
    ...
    Blockly.Msg.REPL_TRY_AGAIN1 = "Failed to Connect to the AppyBuilder Companion, try again.";
