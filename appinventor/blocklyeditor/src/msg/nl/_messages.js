...
Blockly.Msg.nl.switch_language_to_dutch = {
  ...
  init: function() {
    ...
    Blockly.Msg.REPL_COMPANION_OUT_OF_DATE_IMMEDIATE = 'Je gebrukt een oude Companion. Je zou zo snel mogelijk moeten upgraden naar AppyBuilder Companion. Als je automatisch updaten hebt ingesteld in de store, gebeurt de update binnenkort vanzelf.';
