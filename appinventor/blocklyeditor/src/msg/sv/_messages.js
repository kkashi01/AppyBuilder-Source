...
Blockly.Msg.sv.switch_language_to_swedish = {
  ...
  init: function() {
    ...
    Blockly.Msg.REPL_TRY_AGAIN1 = "Kunde inte ansluta till AppyBuilder Companion; försök igen."
    ...
    Blockly.Msg.REPL_COMPANION_OUT_OF_DATE_IMMEDIATE = "Du använder en gammal Companion. Du behöver uppdatera AppyBuilder Companion snarast. Om du har valt autouppdatering i Play Butik, kommer uppdateringen att hända av sig själv inom kort."
