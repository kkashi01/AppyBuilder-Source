     ...
     mutatorXMLStringFunction: function(mutatorAttributes) {
       return '' +
         ...
         '<value name="ARG4"><block type="logic_boolean"><title name="BOOL">TRUE</title></block></value>' +
           '<value name="ARG5"><block type="math_number"><title name="NUM">1</title></block></value>'  +
         '</block>' +
         '</xml>';}},


    {matchingMutatorAttributes:{component_type:"Notifier", method_name:"ShowAlert"},
     mutatorXMLStringFunction: function(mutatorAttributes) {
       return '' +
         '<xml>' +
         '<block type="component_method">' +
         ...
         '<value name="ARG2"><block type="math_number"><title name="NUM">1</title></block></value>' +
         '</block>' +
         '</xml>';}},
    ...
    {matchingMutatorAttributes:{component_type:"Canvas", method_name:"DrawArc"},
     mutatorXMLStringFunction: function(mutatorAttributes) {
       return '' +
         ...
         '</block>' +
         '</xml>';}},
    {matchingMutatorAttributes:{component_type:"Notifier", method_name:"ShowMessageDialog"},
     mutatorXMLStringFunction: function(mutatorAttributes) {
       return '' +
         '<xml>' +
         '<block type="component_method">' +
         //mutator generator
         Blockly.Drawer.mutatorAttributesToXMLString(mutatorAttributes) +
         '<value name="ARG3"><block type="math_number"><title name="NUM">1</title></block></value>' +
         '</block>' +
         '</xml>';}},

    {matchingMutatorAttributes:{component_type:"Notifier", method_name:"ShowProgressDialog"},
     mutatorXMLStringFunction: function(mutatorAttributes) {
       return '' +
         '<xml>' +
         '<block type="component_method">' +
         //mutator generator
         Blockly.Drawer.mutatorAttributesToXMLString(mutatorAttributes) +
         '<value name="ARG2"><block type="math_number"><title name="NUM">0</title></block></value>' +
         '</block>' +
         '</xml>';}},
