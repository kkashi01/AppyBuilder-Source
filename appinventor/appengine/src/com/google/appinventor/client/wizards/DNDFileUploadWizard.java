 ...
 * https://sourceforge.net/p/gwt-uploader/code/ci/master/tree/
 * http://www.moxiegroup.com/moxieapps/gwt-uploader/userguide.jsp
 *
 */
public class DNDFileUploadWizard extends Wizard {
     ...
     *
     * @param folderNode the upload destination folder
     * @param fileUploadedCallback callbacak to be executed after upload
     */
...
//        final Map<String, ProgressBar> progressBars = new LinkedHashMap<String, ProgressBar>();
        ...
        final String maxUploadSize = "2MB";
...
//        Label uploadQueueLabel = new Label("<span class='gwt-Label'>Select File...<br>Max file size :" + maxUploadSize + "</span>");
        HTML uploadQueueLabel = new HTML(new SafeHtmlBuilder().appendEscapedLines("Select File...\nMax file size:" + maxUploadSize).toSafeHtml());
        ...
        final Uploader uploader = new Uploader()
                ...
                .setButtonAction(Uploader.ButtonAction.SELECT_FILES)   // Changes to "SELECT_FILES" for multi-upload
                .setFileSizeLimit(maxUploadSize)        // setting maximum allowed file size
                ;
