 ...
 *
 */
public final class MockListViewCustom extends MockVisibleComponent {

 /**
   * Component type name.
   */
  public static final String TYPE = "ListViewCustom";
   ...
   */
  public MockListViewCustom(SimpleEditor editor) {
    super(editor, TYPE, images.listviewcustom());
