    ...
    for (ComponentCategory category : ComponentCategory.values()) {
      if (showCategory(category)) {
        ...
        categoryPanels.put(category, categoryPanel);
          ...
          // https://www.fileformat.info/info/unicode/char/1f5c0/index.htm
        //  https://www.utf8icons.com/character/10148/black-rightwards-arrowhead
        stackPalette.add(categoryPanel, SafeHtmlUtils.fromString(" ▾ " + title));
      }
    }
