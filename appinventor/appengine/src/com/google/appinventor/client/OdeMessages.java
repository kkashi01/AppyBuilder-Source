...
// https://github.com/ewpatton/appinventor-sources/commit/f77fe3d9e7e87689c0e376e55ec30d10e810c1ca  generates property files
//
/**
...
//  String switchLanguageVietnameseButton();
  ...
  @DefaultMessage("An Email from AppyBuilder Gallery")
  @Description("Title of the email when moderator sends out an email")
  String moderationSendEmailTitle();

  @DefaultMessage("AppyBuilder Gallery: App Activated")
  ...
  @DefaultMessage("AppyBuilder Gallery: App Deactivated")
  ...
  @DefaultMessage("Build with AppyBuilder!")
  @Description("Title for AppyBuilder")
  ...
  @Description("Link for Contact Us form")
  String feedbackLink();
  ...
  @Description("Name of Comminity link")
  ...
  @DefaultMessage("Welcome to AppyBuilder!")
  ...
  @DefaultMessage("Show hidden components in Viewer")
...
//  @DefaultMessage("Check to see Preview on Tablet size.")
  @DefaultMessage("   Preview on Tablet?")
...
//  @DefaultMessage("Un-check to see Preview on Phone size.")
  @DefaultMessage("Un-check to Preview on Phone size")
 ...
 String externalComponentVersion();
  ...
  @DefaultMessage("CyanDark")
  @Description("Text for color choice 'CyanDark'")
  String cyanDarkColor();
 ...
 @DefaultMessage("Indigo")
  @Description("Text for color choice 'Indigo'")
  String indigoColor();
  ...
  @DefaultMessage("WARNING: The number of screens in this app might exceed the limits of AppyBuilder. " +
  ...
  @DefaultMessage("The build server is not compatible with this version of AppyBuilder.")
  @Description("Error message reported when the build server is running a different version of " +
      "the AppyBuilder code.")
  ...
  @DefaultMessage("Do you really want to delete this file?  It will be removed from " +
      "the AppyBuilder server.  Also, parts of your application may still refer to the deleted " +
  ...
  @DefaultMessage("Do you want to overwrite your keystore file?\n\n" +
      "If you agree, your old keystore file will be completely removed from the AppyBuilder " +
      "server.\n\n" +
  ...
  @DefaultMessage("Uploading {0} to the AppyBuilder server")
  ...
  @DefaultMessage("Please explain why you feel this app is disrespectful or inappropriate, or otherwise breaks the <a href=\"http://google.com\">AppyBuilder Gallery Community Guidelines.</a> " +
      "")
  ...
  @DefaultMessage("AppyBuilder will send you a notification "
  ...
  @DefaultMessage("Create new AppyBuilder project")
  ...
  @DefaultMessage("Name this AppyBuilder project")
  ...
  @DefaultMessage("This project was created with an older version of the AppyBuilder " +
  ...
  @DefaultMessage("This project was saved with a newer version of the AppyBuilder system. We " +
  ...
  @DefaultMessage("This project was saved with an early pre-release version of the AppyBuilder " +
  ...
  @DefaultMessage("AppyBuilder is unable to compile this project.  " +
  ...
  @DefaultMessage("ListPickerCustom")
  @Description("")
  String listPickerCustomComponentPallette();

  @DefaultMessage("ListViewCustom")
  @Description("")
  String listViewCustomComponentPallette();
  ...
  @DefaultMessage("GridView")
  @Description("")
  String gridviewComponentPallette();

  @DefaultMessage("WebViewer")
  @Description("")
  String webViewerComponentPallette();

  @DefaultMessage("UseExternalBrowser")
  @Description("")
  String UseExternalBrowserProperties();
  ...
  @DefaultMessage("UseClassicPackageName")
  @Description("")
  String UseClassicPackageNameProperties();
  @DefaultMessage("UseLegacyPackageName")
  @Description("")
  String UseLegacyPackageName();
 ...
 @DefaultMessage("AdClicked")
  @Description("")
  String AdClickedEvents();
  ...
  @DefaultMessage("progressStyle")
  @Description("")
  String progressStyleParams();
  ...
  @DefaultMessage("AllowCamera")
  @Description("")
  String AllowCameraProperties();
  ...
  @DefaultMessage("Component for using the Barcode Scanner to read a variety of barcode types.<p>Refer to this link for types of supported barodes: https://goo.gl/M4dXnz")
  @Description("")
  ...
  @DefaultMessage("<p>A button that, when clicked on, displays a list of " +
  ...
  @Description("")
  String ListPickerCustomHelpStringComponentPallette();

  @DefaultMessage("<p>This is a visible component that displays a list of Images and Text elements." +
          " <br> The list can be set using the ElementsFromString property" +
          " or using the Elements block in the blocks editor. </p>")
  @Description("")
  String ListViewCustomHelpStringComponentPallette();
  ...
  @DefaultMessage("A non-visible component allowing you to store data on a Web database powered by Firebase. " +
      ...
      "By default, data will be stored in AppyBuilder''s shared Firebase database. " +
  ...
  String FirebaseDBHelpStringComponentPallette();
    ...
    @DefaultMessage("Hey there! Please note that GoogleMap is an experimental feature " +
            "which may change in the future or break. <br>Packaged Apps built with this component may not " +
            "function into the indefinite future. <br><br>Please DO NOT use this in production apps.<br><br>")
    @Description("")
    String googlemapWarning();
  ...
  @DefaultMessage("You do not have any projects in AppyBuilder. " +
      "To learn how to use AppyBuilder, click the \"Guide\" " +
  ...
  @DefaultMessage("<h2>Please fill out a short voluntary survey so that we can learn more about our users and improve AppyBuilder.</h2>")
  @Description("")
  ...
  @DefaultMessage("<p><font color=red>Warning:</font> This session is out of date.</p>" +
                "<p>This AppyBuilder account has been opened from another location. " +
  ...
  @DefaultMessage("<p><font color=red>WARNING:</font> A second App " +
                ...
                "continue with both sessions, but working with AppyBuilder from more " +
                "than one session simultaneously can cause blocks to be lost in ways " +
                "that cannot be recovered from the AppyBuilder server.</p><p>" +
                ...
                "have a backup copy independent of the AppyBuilder server. Use " +
  ...
  @DefaultMessage("Companion, Release Notes")
  @Description("Name of Companion link")
  String companionLink();

  @DefaultMessage("Reference Document")
  @Description("Reference Document link")
  String libraryLink();
  ...
  @DefaultMessage("AppyBuilder Comminity")
  @Description("AppyBuilder Forum link")
  String forumsLink();

  @DefaultMessage("Blog Site")
  @Description("Name of BlogSite link")
  String blogLink();

  @DefaultMessage("WiFiList")
  @Description("")
  String WiFiListMethods();
 ...
 @DefaultMessage("ZoomEnabled")
  ...
  @DefaultMessage("<p>A Toggler Displays checked/unchecked states as a button with a 'light' indicator and by default accompanied with the text 'ON' or 'OFF'.</p>")
  @Description("")
  String TogglerHelpStringComponentPallette();

  @DefaultMessage("<p>The component used to query and monitor the battery and its charging status</p>")
  @Description("")
  String BatteryManagerStringComponentPallette();

  @DefaultMessage("<p>Non-visible component that measures the ambient light level (illumination) in lx</p>")
  @Description("")
  ...
  @DefaultMessage("<p>Non-visible component that measures the ambient air pressure in hPa or mbar.</p>")
  @Description("")
  String PressureSensorHelpStringComponentPallette();

  @DefaultMessage("<p>Physical world component that can detect such data as: sound amplitude (measurement of the degree of change [positive or negative] ).</p>")
  @Description("")
  String SoundSensorHelpStringComponentPallette();

  @DefaultMessage("<p>Non-visible component that measures the temperature of the device in degrees Celsius. This sensor implementation varies across devices.</p>")
  @Description("")
  String TemperatureSensorHelpStringComponentPallette();

  @DefaultMessage("<p>Non-visible component that communicates with a FTP server to send, receive, list files</p>")
  @Description("")
  String FtpManagerHelpStringComponentPallette();

 @DefaultMessage("DeleteFolder")
  @Description("")
  String DeleteFolderMethods();

 @DefaultMessage("<p>This is a messaging solution that lets you reliably deliver messages to all client apps. Using this component, you can notify a client app that new email or other data is available to sync. You can send notification messages to drive user reengagement and retention.</p>")
  @Description("")
  String PushNotificationHelpStringComponentPallette();

  @DefaultMessage("<p>A FloatingButton component is a non-visual component that can be shown as floating button on the screen. By default, the button will be at bottom-right of screen. NOTE: For this to work, the Screen Scrollable should be set to true.</p>")
  @Description("")
  String FloatingButtonHelpStringComponentPallette();

  @DefaultMessage("ReCreateFAB")
  @Description("")
  String ReCreateFABMethods();
  @DefaultMessage("<p>Component that provides the primary API for managing aspects of Wi-Fi connectivity. NOTE: This is partial implementation. Have suggestions? Contact us.</p>")
  @Description("")
  String WiFiManagerHelpStringComponentPallette();

  @DefaultMessage("<p>Visible component that show information on Google map.</p>")
  @Description("")
  String GoogleMapHelpStringComponentPallette();

  @DefaultMessage("<p>A visible component that will allow you to display line charts of X, Y, Z data points</p>")
  @Description("")
  String XYChartHelpStringComponentPallette();

  @DefaultMessage("<p>AdAmazon component allows you to monetize your app. You must have a valid publisher id that can be obtained from https://developer.amazon.com. If your publisher id is invalid, the AdAmazon banner will not display on the emulator or the device.</p>")
  @Description("")
  String AdAmazonHelpStringComponentPallette();

  @DefaultMessage("<p>Non-visible component that is used for updating default values in the androidmanifest.xml. The androidmanifest.xml contains all the details needed by the android system about the app.</p>")
  @Description("")
  String KitchenSinkHelpStringComponentPallette();

  @DefaultMessage("<p>A Chronometer is a simple timer that can be started or stopped</p>")
  @Description("")
  String ChronometerHelpStringComponentPallette();

  @DefaultMessage("<p>A GridView is a component that displays items in a two-dimensional, " +
          "scrollable grid. The GridView can contain list of TEXT items or Asset image items OR combination</p>")
  @Description("")
  String GridViewHelpStringComponentPallette();

  @DefaultMessage("<p>A ProgressBar is an animated visual indicator of progress in some operation. It will allow you to setup indicator using different animation styles.</p>")
  @Description("")
  String ProgressBarHelpStringComponentPallette();

  @DefaultMessage("<p>Non-visible component that can be used to manage your private local relational database.</p>")
  @Description("")
  String SQLiteHelpStringComponentPallette();

  @DefaultMessage("<p>A visible component that shows items in a center-locked, horizontally scrolling list</p>")
  @Description("")
  String GalleryViewerHelpStringComponentPallette();
  ...
  @DefaultMessage("<p><p>InAppBilling component lets you sell digital content from inside your applications. It can be used to sell a wide range of content, including downloadable content such as media files or photos, virtual content such as game levels or potions, premium services and features, and more. You can use In-app Billing to sell products as: <ul> <li>Standard in-app products (one-time billing), or</li> <li>Subscriptions (recurring, automated billing)</li> </ul> <p> For more information, please see here: http://tinyurl.com/m3acuk3 and here: http://tinyurl.com/cl7nyuv</p>")
  @Description("")
  String InAppBillingHelpStringComponentPallette();

  @DefaultMessage("<p><p>MMedia component allows you to monetize your app. You must have a valid App id " +
  ...
  @Description("")
  String MMediaHelpStringComponentPallette();

  @DefaultMessage("<p><p>An interstitial ad is a full-page ad. "
  ...
  @Description("")
  String MMediaInterstitialHelpStringComponentPallette();

  @DefaultMessage("Hey there! Please note that FirebaseDB is an experimental feature " +
          "which may change in the future or break. <br>Packaged Apps built with this component may not " +
          "function into the indefinite future. <br><br>Also, please note that FirebaseURL default value is set to our test account, " +
          "which will be shared by all user. <br><br>PLEASE OBTAIN A FIREBASE ACCOUNT FROM http://firebase.com amd change the FirebaseURL to point to your account.")
  @Description("")
  String firebaseExperimentalWarning();

  @DefaultMessage("Hey there! <br><br>1. PushNotification is an experimental feature " +
          "which may change in the future or break. <br>Packaged Apps built with this component may not " +
          "function into the indefinite future. <br><br>2. Please note FirebaseURL default value is set to our test account, " +
          "which will be shared by all user. <br><br>PLEASE OBTAIN A FIREBASE ACCOUNT FROM http://firebase.com " +
          "and change the FirebaseURL to point to your account.<br><br>")
  @Description("")
  String pushNotificationExperimentalWarning();

  @DefaultMessage("Hi there! Webviewer supports file-upload from local storage. It also supports possibility to " +
          "take pictures with your camera and then upload the image! This could be handy for such mobile sites as " +
          "http://facebook.com OR directly uploding images to your server! " +
          "However, by design, to enable taking picture, you will need to drop a Camera component onto your layout. " +
          "You will also need to set AllowCamera property to true." +
          "")
  @Description("")
  String webviewerCameraWarning();
  ...
  @DefaultMessage("Either your session has expired, or AppyBuilder has been upgraded. " +
 ...
 @DefaultMessage("AdExpanded")
  @Description("")
  String AdExpandedEvents();

 @DefaultMessage("AdLoaded")
  @Description("")
  String AdLoadedEvents();

 @DefaultMessage("AdClosed")
  @Description("")
  String AdClosedEvents();

 @DefaultMessage("AdCollapsed")
  @Description("")
  String AdCollapsedEvents();

 @DefaultMessage("AdLeftApplication")
  @Description("")
  String AdLeftApplicationEvents();

 @DefaultMessage("AdDismissed")
  @Description("")
  String AdDismissedEvents();

 @DefaultMessage("AdFailedToLoad")
  @Description("")
  String AdFailedToLoadEvents();

 @DefaultMessage("AdFailedToShow")
  @Description("")
  String AdFailedToShowEvents();

 @DefaultMessage("LoadAd")
  @Description("")
  String LoadAdMethods();

 @DefaultMessage("ShowInterstitialAd")
  @Description("")
  String ShowInterstitialAdMethods();

 @DefaultMessage("DestroyAd")
  @Description("")
  String DestroyAdMethods();

 @DefaultMessage("PauseAd")
  @Description("")
  String PauseAdMethods();

 @DefaultMessage("ResumeAd")
  @Description("")
  String ResumeAdMethods();

 @DefaultMessage("TargetGender")
  @Description("")
  String TargetGenderProperties();

 @DefaultMessage("AppID")
  @Description("")
  String AppIDProperties();

 @DefaultMessage("DebugEnabled")
  @Description("")
  String DebugEnabledProperties();

 @DefaultMessage("PublisherId")
  @Description("")
  String PublisherIdProperties();

 @DefaultMessage("RefreshAd")
  @Description("")
  String RefreshAdProperties();

 @DefaultMessage("ApplicationKey")
  @Description("")
  String ApplicationKeyProperties();

 @DefaultMessage("EnableDebug")
  @Description("")
  String EnableDebugProperties();

 @DefaultMessage("EnableGeoLocationTargeting")
  @Description("")
  String EnableGeoLocationTargetingProperties();

 @DefaultMessage("EnableTesting")
  @Description("")
  String EnableTestingProperties();

 @DefaultMessage("TargetAge")
  @Description("")
  String TargetAgeProperties();

 @DefaultMessage("AdEnabled")
  @Description("")
  String AdEnabledProperties();

 @DefaultMessage("AdUnitID")
  @Description("")
  String AdUnitIDProperties();

 @DefaultMessage("TargetForChildren")
  @Description("")
  String TargetForChildrenProperties();

 @DefaultMessage("TestMode")
  @Description("")
  String TestModeProperties();

 @DefaultMessage("BatteryHealth")
  @Description("")
  String BatteryHealthProperties();

 @DefaultMessage("BatteryLevel")
  @Description("")
  String BatteryLevelProperties();

 @DefaultMessage("ClearGridView")
  @Description("")
  String ClearGridViewMethods();

 @DefaultMessage("StartMonitoring")
  @Description("")
  String StartMonitoringProperties();

 @DefaultMessage("BatteryPlugged")
  @Description("")
  String BatteryPluggedProperties();

 @DefaultMessage("BatteryPresent")
  @Description("")
  String BatteryPresentProperties();

 @DefaultMessage("BatteryTemperature")
  @Description("")
  String BatteryTemperatureProperties();

 @DefaultMessage("BatteryVoltage")
  @Description("")
  String BatteryVoltageProperties();

 @DefaultMessage("GetBatteryInfo")
  @Description("")
  String GetBatteryInfoMethods();
 ...
 @DefaultMessage("Amplitude")
  @Description("")
  String AmplitudeProperties();

 @DefaultMessage("Decibel")
  @Description("")
  String DecibelProperties();

 @DefaultMessage("Listen")
  @Description("")
  String ListenProperties();

 @DefaultMessage("SoundLevel")
  @Description("")
  String SoundLevelProperties();

 @DefaultMessage("MaxSoundlevel")
  @Description("")
  String MaxSoundlevelProperties();

 @DefaultMessage("SoundChanged")
  @Description("")
  String SoundChangedEvents();


 @DefaultMessage("PressureChanged")
  @Description("")
  String PressureChangedEvents();
 ...
 @DefaultMessage("CopyToClipboard")
  @Description("")
  String CopyToClipboardMethods();

 @DefaultMessage("DeviceInfo")
  @Description("")
  String DeviceInfoMethods();

 @DefaultMessage("DeviceInfoKey")
  @Description("")
  String DeviceInfoKeyMethods();

 @DefaultMessage("GetImageMetaData")
  @Description("")
  String GetImageMetaDataMethods();

 @DefaultMessage("HideSoftKeyboard")
  @Description("")
  String HideSoftKeyboardProperties();

 @DefaultMessage("IsGPSEnabled")
  @Description("")
  String IsGPSEnabledProperties();

 @DefaultMessage("IsGPSEnabledDevice")
  @Description("")
  String IsGPSEnabledDeviceProperties();
 ...
 @DefaultMessage("IsNetworkAvailable")
  @Description("")
  String IsNetworkAvailableProperties();

 @DefaultMessage("KeepScreenOn")
  @Description("")
  String KeepScreenOnProperties();

 @DefaultMessage("NotificationBarVisible")
  @Description("")
  String NotificationBarVisibleProperties();

 @DefaultMessage("StartGPSOptions")
  @Description("")
  String StartGPSOptionsProperties();

 @DefaultMessage("PasteFromClipboard")
  @Description("")
  String PasteFromClipboardMethods();

@DefaultMessage("ElapsedTimeInSec")
  @Description("")
  String ElapsedTimeInSecProperties();

@DefaultMessage("ShouldResume")
  @Description("")
  String ShouldResumeProperties();

@DefaultMessage("Started")
  @Description("")
  String StartedProperties();

@DefaultMessage("TextOff")
  @Description("")
  String TextOffProperties();

@DefaultMessage("TextOn")
  @Description("")
  String TextOnProperties();

@DefaultMessage("Images")
  @Description("")
  String ImagesProperties();

@DefaultMessage("Padding")
  @Description("")
  String PaddingProperties();

@DefaultMessage("ThumbnailHeight")
  @Description("")
  String ThumbnailHeightProperties();

@DefaultMessage("ThumbnailWidth")
  @Description("")
  String ThumbnailWidthProperties();

@DefaultMessage("Yandex_API_Key")
  @Description("")
  String Yandex_API_KeyProperties();
...
@DefaultMessage("AfterAction")
  @Description("")
  String AfterActionEvents();

@DefaultMessage("FtpConnectionError")
  @Description("")
  String FtpConnectionErrorEvents();
...
@DefaultMessage("MakeDir")
  @Description("")
  String MakeDirMethods();

@DefaultMessage("ServerPassword")
  @Description("")
  String ServerPasswordProperties();

@DefaultMessage("ServerURL")
  @Description("")
  String ServerURLProperties();

@DefaultMessage("ServerUserId")
  @Description("")
  String ServerUserIdProperties();

@DefaultMessage("Upload")
  @Description("")
  String UploadMethods();

@DefaultMessage("GetMacAddress")
  @Description("")
  String GetMacAddressMethods();

@DefaultMessage("GetVersionName")
  @Description("")
  String GetVersionNameMethods();

@DefaultMessage("GotWiFiList")
  @Description("")
  String GotWiFiListEvents();
...
@DefaultMessage("DisplayTables")
  @Description("")
  String DisplayTablesMethods();

@DefaultMessage("DropTable")
  @Description("")
  String DropTableMethods();

@DefaultMessage("RowsAffected")
  @Description("")
  String RowsAffectedProperties();

@DefaultMessage("RunQuery")
  @Description("")
  String RunQueryMethods();


@DefaultMessage("UserEMailAccounts")
  @Description("")
  String UserEMailAccountsMethods();

@DefaultMessage("GetDeviceInfo")
  @Description("")
  String GetDeviceInfoMethods();

@DefaultMessage("GetDeviceId")
  @Description("")
  String GetDeviceIdMethods();

@DefaultMessage("FlashtOn")
  @Description("")
  String FlashtOnMethods();

@DefaultMessage("HasFlash")
  @Description("")
  String HasFlashMethods();

@DefaultMessage("MenuEnabled")
  @Description("")
  String MenuEnabledProperties();

@DefaultMessage("InitializeMenu")
  @Description("")
  String InitializeMenuEvents();

@DefaultMessage("MenuItemSelected")
  @Description("")
  String MenuItemSelectedEvents();

@DefaultMessage("MenuClearAll")
  @Description("")
  String MenuClearAllMethods();

@DefaultMessage("MenuItemAdd")
  @Description("")
  String MenuItemAddMethods();

@DefaultMessage("MenuReset")
  @Description("")
  String MenuResetMethods();

@DefaultMessage("MenuShow")
  @Description("")
  String MenuShowMethods();

@DefaultMessage("TakeScreenshot")
  @Description("")
  String TakeScreenshotMethods();

@DefaultMessage("AfterTakeScreenshot")
  @Description("")
  String AfterTakeScreenshotEvents();

@DefaultMessage("RefreshChart")
  @Description("")
  String RefreshChartProperties();

@DefaultMessage("XAxisLabel")
  @Description("")
  String XAxisLabelProperties();

@DefaultMessage("XMaxValue")
  @Description("")
  String XMaxValueProperties();

@DefaultMessage("XMinValue")
  @Description("")
  String XMinValueProperties();

@DefaultMessage("YAxisLabel")
  @Description("")
  String YAxisLabelProperties();

@DefaultMessage("YMaxValue")
  @Description("")
  String YMaxValueProperties();

@DefaultMessage("YMinValue")
  @Description("")
  String YMinValueProperties();

@DefaultMessage("Unzip")
  @Description("")
  String UnzipMethods();
...
@DefaultMessage("FileSize")
  @Description("")
  String FileSizeMethods();

  @DefaultMessage("StretchEnabled")
  @Description("")
  String StretchEnabledProperties();

@DefaultMessage("FontTypefaceCustom")
  @Description("")
  String FontTypefaceCustomProperties();

@DefaultMessage("DeleteValue")
  @Description("")
  String DeleteValueMethods();

@DefaultMessage("BillingError")
  @Description("")
  String BillingErrorEvents();

@DefaultMessage("PurchaseHistoryRestored")
  @Description("")
  String PurchaseHistoryRestoredEvents();

@DefaultMessage("GetPurchaseListingDetails")
  @Description("")
  String GetPurchaseListingDetailsMethods();

@DefaultMessage("GetPurchaseTransactionDetails")
  @Description("")
  String GetPurchaseTransactionDetailsMethods();

@DefaultMessage("GetSubscriptioListingDetails")
  @Description("")
  String GetSubscriptioListingDetailsMethods();

@DefaultMessage("GetSubscriptionTransactionDetails")
  @Description("")
  String GetSubscriptionTransactionDetailsMethods();

@DefaultMessage("IsPurchased")
  @Description("")
  String IsPurchasedMethods();

@DefaultMessage("IsSubscribed")
  @Description("")
  String IsSubscribedMethods();

@DefaultMessage("ListOwnedProducts")
  @Description("")
  String ListOwnedProductsMethods();

@DefaultMessage("ListOwnedSubscriptions")
  @Description("")
  String ListOwnedSubscriptionsMethods();

@DefaultMessage("LoadOwnedPurchasesFromGoogle")
  @Description("")
  String LoadOwnedPurchasesFromGoogleMethods();

@DefaultMessage("ProductPurchased")
  @Description("")
  String ProductPurchasedEvents();

@DefaultMessage("StartPurchase")
  @Description("")
  String StartPurchaseMethods();

@DefaultMessage("LicenseKey")
  @Description("")
  String LicenseKeyProperties();

@DefaultMessage("BillingInitialized")
  @Description("")
  String BillingInitializedEvents();

@DefaultMessage("ConsumePurchase")
  @Description("")
  String ConsumePurchaseMethods();

@DefaultMessage("StartSubscription")
  @Description("")
  String StartSubscriptionMethods();

@DefaultMessage("DatabaseName")
  @Description("")
  String DatabaseNameProperties();

@DefaultMessage("ButtonSize")
  @Description("")
  String ButtonSizeProperties();

@DefaultMessage("MarginBottom")
  @Description("")
  String MarginBottomProperties();

@DefaultMessage("MarginRight")
  @Description("")
  String MarginRightProperties();

  @DefaultMessage("GetTagsAndValues")
  @Description("")
  String GetTagsAndValuesMethods();

  @DefaultMessage("Hyperlinked")
  @Description("")
  String HyperlinkedProperties();

  @DefaultMessage("ListViewItemStyle")
  @Description("")
  String ListViewItemStyleProperties();

  @DefaultMessage("AfterDeleting")
  @Description("")
  String AfterDeletingEvents();

  @DefaultMessage("ActionBarColor")
  @Description("")
  String ActionBarColorProperties();

 @DefaultMessage("Color")
  @Description("")
  String ColorProperties();

  @DefaultMessage("MarqueeEnabled")
  @Description("")
  String MarqueeEnabledProperties();

  @DefaultMessage("Subject")
  @Description("")
  String SubjectProperties();

   @DefaultMessage("EmailTo")
  @Description("")
  String EmailToProperties();

   @DefaultMessage("EmailCC")
  @Description("")
  String EmailCCProperties();

   @DefaultMessage("IsListening")
  @Description("")
  String IsListeningMethods();

   @DefaultMessage("StopSubscription")
  @Description("")
  String StopSubscriptionMethods();

   @DefaultMessage("TopicPath")
  @Description("")
  String TopicPathProperties();

   @DefaultMessage("DeletedItems")
  @Description("")
  String DeletedItemsProperties();

   @DefaultMessage("FilterBarText")
  @Description("")
  String FilterBarTextProperties();

  @DefaultMessage("ListPickerItemStyle")
  @Description("")
  String ListPickerItemStyleProperties();

  @DefaultMessage("ListPickerStyle")
  @Description("")
  String ListPickerStyleProperties();

  @DefaultMessage("SortOrder")
  @Description("")
  String SortOrderProperties();

  @DefaultMessage("CurrrentPosition")
  @Description("")
  String CurrrentPositionProperties();
  ...
  @DefaultMessage("SeekTo")
  @Description("")
  String SeekToProperties();

  @DefaultMessage("RunInBackground")
  @Description("")
  String RunInBackgroundProperties();

  @DefaultMessage("AnimationStyle")
  @Description("")
  String AnimationStyleProperties();

  // Used in editor/youngandroid/properties/YoungAndroidTextReceivingPropertyEditor.java
  @DefaultMessage("None")
  @Description("Elements will not be sorted")
  String sortOrderNone();

  @DefaultMessage("Ascending")
  @Description("Elements will be sorted in ascending order")
  String sortOrderAscending();

  @DefaultMessage("Descending")
  @Description("Elements will be sorted in descending order")
  String sortOrderDescending();

  @DefaultMessage("Right")
  @Description("Elements will animate from right to left")
  String listpickerItemStyleRight();

  @DefaultMessage("default")
  @Description("Elements will not animate. This is default behaviour")
  String listpickerItemStyleNone();

  @DefaultMessage("Left")
  @Description("Elements will animate from left to right")
  String listpickerItemStyleLeft();

  @DefaultMessage("Bottom")
  @Description("Elements will animate from bottom to top")
  String listpickerItemStyleBottom();

  @DefaultMessage("BottomRight")
  @Description("Elements will animate from bottom-right to top")
  String listpickerItemStyleBottomRight();

  @DefaultMessage("Default")
  @Description("ListPicker default style")
  String listpickerStyleDefault();

  @DefaultMessage("Light")
  @Description("ListPicker Light style")
  String listpickerStyleLight();

  @DefaultMessage("Dialog")
  @Description("ListPicker Dialog style")
  String listpickerStyleDialog();

  @DefaultMessage("Translucent")
  @Description("ListPicker Translucent style")
  String listpickerStyleTranslucent();

  @DefaultMessage("HoloLight")
  @Description("ListPicker HoloLight style")
  String listpickerStyleHoloLight();

  @DefaultMessage("Swipe")
  @Description("Elements can be deleted by swiping the item to right or left. Once done, remaining items will be pushed up")
  String listpickerItemStyleSwipe();

  @DefaultMessage("Scale")
  @Description("Elements will animate scaling from small font to large font")
  String listpickerItemStyleScale();

  @DefaultMessage("Alpha")
  @Description("Elements will gradually appear by changing their Alpha level from 0 to 100")
  String listpickerItemStyleAlpha();

  @DefaultMessage("Default")
  @Description("Application will display in Default mode; with Notification & Title bars; unless KitchenSink has been used")
  String applicationStyleDefault();

  @DefaultMessage("All")
  @Description("Females and males")
  String genderAll();
  ...
  // ===== floating buttons
  @DefaultMessage("Right  Bottom")
  @Description("Floating bottom at right bottom")
  String fbRightBottom();

  @DefaultMessage("Right Top")
  @Description("Floating bottom at right top")
  String fbRightTop();

  @DefaultMessage("Left Bottom")
  @Description("Floating bottom at left bottom")
  String fbLeftBottom();

  @DefaultMessage("Left Top")
  @Description("Floating bottom at left top")
  String fbLeftTop();

  @DefaultMessage("Top Center")
  @Description("Floating bottom at top center")
  String fbTopCenter();

  @DefaultMessage("Bottom Center")
  @Description("Floating bottom at bottom center")
  String fbBottomCenter();
  ...
  @DefaultMessage("wasSuccess")
  @Description("")
  String wasSuccessParams();

  @DefaultMessage("action")
  @Description("")
  String actionParams();

  @DefaultMessage("fromFullPath")
  @Description("")
  String fromFullPathParams();

  @DefaultMessage("toFullPath")
  @Description("")
  String toFullPathParams();

  @DefaultMessage("shouldOverwrite")
  @Description("")
  String shouldOverwriteParams();

  @DefaultMessage("fullPath")
  @Description("")
  String fullPathParams();

  @DefaultMessage("toDestFolder")
  @Description("")
  String toDestFolderParams();

  @DefaultMessage("fromDir")
  @Description("")
  String fromDirParams();

  @DefaultMessage("matching")
  @Description("")
  String matchingParams();

  @DefaultMessage("toDir")
  @Description("")
  String toDirParams();

  @DefaultMessage("zipFileName")
  @Description("")
  String zipFileNameParams();

  @DefaultMessage("menuItem")
  @Description("")
  String menuItemParams();

  @DefaultMessage("remotePath")
  @Description("")
  String remotePathParams();

  @DefaultMessage("remoteFile")
  @Description("")
  String remoteFileParams();

  @DefaultMessage("localPath")
  @Description("")
  String localPathParams();

  @DefaultMessage("isRemote")
  @Description("")
  String isRemoteParams();

  @DefaultMessage("newDirName")
  @Description("")
  String newDirNameParams();

  @DefaultMessage("localFileName")
  @Description("")
  String localFileNameParams();
  ...
  @DefaultMessage("bearing")
  @Description("")
  String bearingParams();
  ...
  @DefaultMessage("centerLat")
  @Description("")
  String centerLatParams();

  @DefaultMessage("centerLng")
  @Description("")
  String centerLngParams();

  @DefaultMessage("markerId")
  @Description("")
  String markerIdParams();
  ...
  @Description("")
  String strokeWidthParams();

  @DefaultMessage("strokeColor")
  @Description("")
  String strokeColorParams();

  @DefaultMessage("draggable")
  @Description("")
  String draggableParams();

  @DefaultMessage("markers")
  @Description("")
  String markersParams();

  @DefaultMessage("jsonString")
  @Description("")
  String jsonStringParams();

  @DefaultMessage("neLat")
  @Description("")
  String neLatParams();

  @DefaultMessage("neLng")
  @Description("")
  String neLngParams();

  @DefaultMessage("swLat")
  @Description("")
  String swLatParams();

  @DefaultMessage("swLng")
  @Description("")
  String swLngParams();
  ...
  @DefaultMessage("circleId")
  @Description("")
  String circleIdParams();

  @DefaultMessage("layerName")
  @Description("")
  String layerNameParams();

  @DefaultMessage("propertyName")
  @Description("")
  String propertyNameParams();

  @DefaultMessage("latMin")
  @Description("")
  String latMinParams();

  @DefaultMessage("latMax")
  @Description("")
  String latMaxParams();

  @DefaultMessage("lonMin")
  @Description("")
  String lonMinParams();

  @DefaultMessage("lonMax")
  @Description("")
  String lonMaxParams();

  @DefaultMessage("latitudeInDegrees")
  @Description("")
  String latitudeInDegreesParams();

  @DefaultMessage("longitudeInDegrees")
  @Description("")
  String longitudeInDegreesParams();

  @DefaultMessage("halfSideInKm")
  @Description("")
  String halfSideInKmParams();
  ...
  @DefaultMessage("isReadyToPurchase")
  @Description("")
  String isReadyToPurchaseParams();

  @DefaultMessage("ownedProducts")
  @Description("")
  String ownedProductsParams();

  @DefaultMessage("ownedSubscriptions")
  @Description("")
  String ownedSubscriptionsParams();

  @DefaultMessage("prodId")
  @Description("")
  String prodIdParams();
  ...
  @DefaultMessage("isAutoRenewing")
  @Description("")
  String isAutoRenewingParams();

  @DefaultMessage("purchaseDateTime")
  @Description("")
  String purchaseDateTimeParams();

  @DefaultMessage("purchaseHistory")
  @Description("")
  String purchaseHistoryParams();

  @DefaultMessage("productId")
  @Description("")
  String productIdParams();

  @DefaultMessage("light")
  @Description("")
  String lightParams();

  @DefaultMessage("deletedItem")
  @Description("")
  String deletedItemParams();
  ...
  @Description("")
  String htmlContentParams();

  @DefaultMessage("wifiList")
  @Description("")
  String wifiListParams();

  @DefaultMessage("AdAmazon")
  @Description("")
  String adAmazonComponentPallette();

  @DefaultMessage("MMedia")
  @Description("")
  String mMediaComponentPallette();

 @DefaultMessage("MMedia")
  @Description("")
  String mMediaComponentPalletteComponentPallette();

 @DefaultMessage("MMediaInterstitial")
  @Description("")
  String mMediaInterstitialComponentPallette();

  @DefaultMessage("AdAmazonInterstitial")
  @Description("adAmazonInterstitial")
  String adAmazonInterstitialComponentPallette();
  ...
  @DefaultMessage("BatteryManager")
  @Description("")
  String batteryManagerComponentPallette();

  @DefaultMessage("Chronometer")
  @Description("")
  String chronometerComponentPallette();

  @DefaultMessage("FloatingButton")
  @Description("")
  String floatingButtonComponentPallette();

  @DefaultMessage("FtpManager")
  @Description("")
  String ftpManagerComponentPallette();

  @DefaultMessage("GalleryViewer")
  @Description("")
  String galleryViewerComponentPallette();

  @DefaultMessage("GoogleMap")
  @Description("")
  String googleMapComponentPallette();

  @DefaultMessage("GridView")
  @Description("")
  String gridViewComponentPallette();

  @DefaultMessage("InAppBilling")
  @Description("")
  String inAppBillingComponentPallette();

  @DefaultMessage("KitchenSink")
  @Description("")
  String kitchenSinkComponentPallette();
  ...
  @DefaultMessage("PressureSensor")
  @Description("")
  String pressureSensorComponentPallette();

  @DefaultMessage("ProgressBar")
  @Description("")
  String progressBarComponentPallette();

  @DefaultMessage("PushNotification")
  @Description("")
  String pushNotificationComponentPallette();

  @DefaultMessage("SQLite")
  @Description("")
  String sQLiteComponentPallette();

  @DefaultMessage("SoundSensor")
  @Description("")
  String soundSensorComponentPallette();

  @DefaultMessage("TemperatureSensor")
  @Description("")
  String temperatureSensorComponentPallette();

  @DefaultMessage("Toggler")
  @Description("")
  String togglerComponentPallette();

  @DefaultMessage("WiFiManager")
  @Description("")
  String wiFiManagerComponentPallette();

  @DefaultMessage("XYChart")
  @Description("")
  String xYChartComponentPallette();

  @DefaultMessage("Advanced")
  @Description("")
  String advancedComponentPallette();
  ...
  @Description("")
  String monetizeComponentPallette();

  @DefaultMessage("Visualization")
  @Description("")
  String visualizationComponentPallette();

  @DefaultMessage("BatteryManager component can get information about device battery health, temperature, battery level, voltage, etc.")
  @Description("")
  String BatteryManagerHelpStringComponentPallette();

  @DefaultMessage("GetRealPathFromURI")
  @Description("")
  String GetRealPathFromURIMethods();
  ...
  @DefaultMessage("ApplicationPackage")
  @Description("")
  String ApplicationPackageProperties();

  @DefaultMessage("NavigationEnabled")
  @Description("")
  String NavigationEnabledProperties();

  @DefaultMessage("PlaybackRate")
  @Description("")
  String PlaybackRateProperties();

  @DefaultMessage("Linkify")
  @Description("")
  String LinkifyProperties();

  @DefaultMessage("listItem")
  @Description("")
  String listItemParams();

  @DefaultMessage("listIcons")
  @Description("")
  String listIconsParams();

  @DefaultMessage("listImages")
  @Description("")
  String listImagesParams();

  @DefaultMessage("itemValue")
  @Description("")
  String itemValueParams();

 @DefaultMessage("listItems")
  @Description("")
  String listItemsParams();

  @DefaultMessage("CreateNavigation")
  @Description("")
  String CreateNavigationMethods();

  @DefaultMessage("ElementsFromLists")
  @Description("")
  String ElementsFromListsMethods();

  @DefaultMessage("RadioButton")
  @Description("")
  String RadioButton2HelpStringComponentPallette();

  @DefaultMessage("RadioGroupArrangement")
  @Description("")
  String RadioGroupArrangementHelpStringComponentPallette();

  @DefaultMessage("RadioButton")
  @Description("")
  String radioButton2ComponentPallette();

  @DefaultMessage("RadioGroupArrangement")
  @Description("")
  String radioGroupArrangementComponentPallette();

  @DefaultMessage("GroupOrientation")
  @Description("")
  String GroupOrientationProperties();

  @DefaultMessage("GroupID")
  @Description("")
  String GroupIDProperties();

  @DefaultMessage("radioButtonId")
  @Description("")
  String radioButtonIdParams();
 ...
 @DefaultMessage("ImageSize")
  @Description("Width and Height of the thumbnail size")
  String ImageSizeProperties();

  @DefaultMessage("RatingBar")
  @Description("")
  String ratingBarComponentPallette();


  @DefaultMessage("A RatingBar is a ProgressBar that shows a rating in stars. The user can touch/drag or use arrow keys to set the rating")
  @Description("")
  String RatingBarHelpStringComponentPallette();

  @DefaultMessage("NumStars")
  @Description("")
  String NumStarsProperties();

  @DefaultMessage("Rating")
  @Description("")
  String RatingProperties();

  @DefaultMessage("StarColor")
  @Description("")
  String StarColorProperties();

  @DefaultMessage("StepSize")
  @Description("")
  String StepSizeProperties();

  @DefaultMessage("Rating")
  @Description("")
  String ratingParams();

  @DefaultMessage("AllowSelection")
  @Description("Show user be allowed to make selection?")
  String AllowSelectionProperties();


  @DefaultMessage("SetShadow")
  @Description("")
  String SetShadowMethods();

  @DefaultMessage("startColor")
  @Description("")
  String startColorParams();

  @DefaultMessage("endColor")
  @Description("")
  String endColorParams();

  @DefaultMessage("orientation")
  @Description("")
  String orientationParams();

  @DefaultMessage("A Switch is a two-state toggle switch component that can select between two options. " +
  ...
  @DefaultMessage("TrackColor")
  @Description("")
  String TrackColorProperties();

  @DefaultMessage("StarsBackgroundColor")
  @Description("")
  String StarsBackgroundColorProperties();


  @DefaultMessage("ShowRadioButtons")
  @Description("")
  String ShowRadioButtonsProperties();

  @DefaultMessage("CreateRoundImage")
  @Description("")
  String CreateRoundImageMethods();

  @DefaultMessage("picture")
  @Description("")
  String pictureParams();

  @DefaultMessage("size")
  @Description("")
  String sizeParams();

  @DefaultMessage("StatusBarColor")
  @Description("Device StatusBar color")
  String StatusBarColorProperties();
  ...
  @DefaultMessage("TitleFontSize")
  @Description("")
  String TitleFontSizeProperties();

  @DefaultMessage("BoxColor")
  @Description("")
  String BoxColorProperties();

  @DefaultMessage("CheckboxColor")
  @Description("")
  String CheckboxColorProperties();

  @DefaultMessage("IsKeyboardOpen")
  @Description("")
  String IsKeybaordOpenProperties();

  @DefaultMessage("ControlsEnabled")
  @Description("")
  String ControlsEnabledProperties();

  @DefaultMessage("isChecked")
  @Description("")
  String isCheckedParams();

  @DefaultMessage("LinedTextBox is same as TextBox component. However, it includes visible notepad line lines. Changing fontsize will " +
          "properly space-out the lines")
  @Description("")
  String LinedTextBoxHelpStringComponentPallette();

  @DefaultMessage("LinedTextBox")
  @Description("")
  String linedTextBoxComponentPallette();

 @DefaultMessage("SubscriptionEnabled")
  @Description("")
  String SubscriptionEnabledMethods();

 @DefaultMessage("VibrateEnabled")
  @Description("")
  String VibrateEnabledMethods();

 @DefaultMessage("SoundEnabled")
  @Description("")
  String SoundEnabledMethods();

 @DefaultMessage("VibrateEnabled")
  @Description("")
  String VibrateEnabledProperties();

 @DefaultMessage("SoundEnabled")
  @Description("")
  String SoundEnabledProperties();

 @DefaultMessage("SubscriptionEnabled")
  @Description("")
  String SubscriptionEnabledProperties();

 @DefaultMessage("NetworkManager")
  @Description("")
  String networkManagerComponentPallette();

 @DefaultMessage("This component can be used to provide information about network")
  @Description("")
  String NetworkManagerHelpStringComponentPallette();

// The block in blocks editor will show this message
@DefaultMessage("GetConnectionType")
  @Description("")
  String GetConnectionTypeMethods();

@DefaultMessage("IsFastConnection")
  @Description("")
  String IsFastConnectionMethods();

  @DefaultMessage("IsWiFiConnection")
  @Description("")
  String IsWiFiConnectionMethods();

 @DefaultMessage("IsMobileConnection")
  @Description("")
  String IsMobileConnectionMethods();

 @DefaultMessage("IsRoaming")
  @Description("")
  String IsRoamingMethods();

 @DefaultMessage("CardView")
  @Description("")
  String cardViewComponentPallette();

 @DefaultMessage("thi sis the definintion for the CardView")
  @Description("")
  String CardViewHelpStringComponentPallette();

 @DefaultMessage("Elevation")
  @Description("")
  String ElevationProperties();

 @DefaultMessage("Cardview help message here ")
  @Description("")
  String MyCardViewHelpStringComponentPallette();

 @DefaultMessage("MyCardView")
  @Description("")
  String myCardViewComponentPallette();

 @DefaultMessage("SubTitle")
  @Description("")
  String SubTitleProperties();

 @DefaultMessage("IsCard")
  @Description("")
  String IsCardProperties();

@DefaultMessage("UseRoundCorner")
  @Description("")
  String UseRoundCornerProperties();

 @DefaultMessage("CreateCard")
  @Description("")
  String CreateCardMethods();

 @DefaultMessage("TopImagePath")
  @Description("")
  String topImagePathParams();
 ...
 @DefaultMessage("Content")
  ...
  @DefaultMessage("MemoryInfo")
  @Description("")
  String memoryInfoComponentPallette();

  @DefaultMessage("MemoryInfo")
  @Description("")
  String MemoryInfoComponentPallette();

  @DefaultMessage("Nonvisible component to retireve information about device memory")
  @Description("")
  String MemoryInfoHelpStringComponentPallette();

  @DefaultMessage("ExternalStorage")
  @Description("")
  String ExternalStorageAvailableMethods();

  @DefaultMessage("MemoryFree")
  @Description("")
  String MemoryFreeMethods();

  @DefaultMessage("MemoryUsed")
  @Description("")
  String MemoryUsedMethods();

  @DefaultMessage("ExternalStorageUsed")
  @Description("")
  String ExternalStorageUsedMethods();

  @DefaultMessage("InternalStorageAvailable")
  @Description("")
  String InternalStorageAvailableMethods();

  @DefaultMessage("InternalStorageTotal")
  @Description("")
  String InternalStorageTotalMethods();

  @DefaultMessage("InternalStorageUsed")
  @Description("")
  String InternalStorageUsedMethods();

  @DefaultMessage("MemoryTotal")
  @Description("")
  String MemoryTotalMethods();

  @DefaultMessage("ExternalStorageTotal")
  @Description("")
  String ExternalStorageTotalMethods();
  ...
  @Description("")
  String ReadMoreProperties();


  //======
  @DefaultMessage("ShowStyledAlert")
  @Description("")
  String ShowStyledAlertMethods();

  @DefaultMessage("alertType")
  @Description("")
  String alertTypeParams();

  @DefaultMessage("TitleColor")
  @Description("")
  String TitleColorProperties();

  @DefaultMessage("showAtBottom")
  @Description("")
  String showAtBottomParams();

  @DefaultMessage("animationType")
  @Description("")
  String animationTypeParams();

  @DefaultMessage("Custom...")
  @Description("")
  String customEllipsis();

  @DefaultMessage("WallpaperManager")
  @Description("")
  String wallpaperManagerComponentPallette();

  @DefaultMessage("A non-visible component that provides access to the system wallpaper. " +
          "With this component, you can set the current wallpaper and more.")
  @Description("")
  String WallpaperManagerHelpStringComponentPallette();

  @DefaultMessage("CreateWallpaper")
  @Description("")
  String CreateWallpaperMethods();

  @DefaultMessage("SetWallpaper")
  @Description("")
  String SetWallpaperMethods();

  @DefaultMessage("LoadImageIntoView")
  @Description("")
  String LoadImageIntoViewMethods();

  @DefaultMessage("GetWallpaper")
  @Description("")
  String GetWallpaperMethods();

  @DefaultMessage("shapeType")
  @Description("")
  String shapeTypeParams();

  @DefaultMessage("ShapesManager")
  @Description("")
  String shapesManagerComponentPallette();

  @DefaultMessage("ShapesManagerHelpStringComponent")
  @Description("")
  String ShapesManagerHelpStringComponentPallette();

//  @DefaultMessage("ApplyShape")
//  @Description("")
//  String ApplyShapeMethods();

  @DefaultMessage("Spacer")
  @Description("")
  String spacerComponentPallette();

  @DefaultMessage("Spacer is a lightweight component that may be used to create space/gap between components. " +
          "The Sapcer WILL NOT be visible in the .apk")
  @Description("")
  String SpacerHelpStringComponentPallette();

  @DefaultMessage("SetTitleBarCustomFont")
  @Description("")
  String SetTitleBarCustomFontProperties();


  @DefaultMessage("PerformClick")
  @Description("")
  String PerformClickProperties();

  @DefaultMessage("PerformClick")
  @Description("")
  String PerformClickMethods();

  @DefaultMessage("ImageEffect")
  @Description("")
  String ImageEffectMethods();
  ...
  @DefaultMessage("TitleImage")
  @Description("")
  String TitleImageProperties();

  @DefaultMessage("IS_Interstitial")
  @Description("")
  String ironSourceComponentPallette();

  @DefaultMessage("xxxxxxx Description of ironsrouce goes here")
  @Description("")
  String IronSourceHelpStringComponentPallette();

  @DefaultMessage("selectionIndex")
  @Description("")
  String selectionIndexParams();

  @DefaultMessage("OfferwallClosed")
  @Description("")
  String OfferwallClosedEvents();

  @DefaultMessage("OfferwallCreditFailed")
  @Description("")
  String OfferwallCreditFailedEvents();

 @DefaultMessage("OfferwallCreditFailed")
  @Description("")
  String OfferwallCreditedEvents();

 @DefaultMessage("OfferwallLoaded")
  @Description("")
  String OfferwallLoadedEvents();

 @DefaultMessage("OfferwallOpened")
  @Description("")
  String OfferwallOpenedEvents();

 @DefaultMessage("OfferwallShowFailed")
  @Description("")
  String OfferwallShowFailedEvents();

 @DefaultMessage("ShowOfferwall")
  @Description("")
  String ShowOfferwallMethods();

 @DefaultMessage("isCredited")
  @Description("")
  String isCreditedParams();

 @DefaultMessage("LoadOfferwall")
  @Description("")
  String LoadOfferwallMethods();

 @DefaultMessage("IS_Interstitial")
  @Description("")
  String IS_InterstitialHelpStringComponentPallette();

 @DefaultMessage("AppKey")
  @Description("")
  String AppKeyProperties();

 @DefaultMessage("LoadInterstitialAd")
  @Description("")
  String LoadInterstitialAdMethods();

@DefaultMessage("IS_Offerwall")
  @Description("")
  String iS_OfferwallComponentPallette();

@DefaultMessage("IS_Offerwall")
  @Description("")
  String IS_OfferwallHelpStringComponentPallette();

@DefaultMessage("IS_Interstitial")
  @Description("")
  String iS_InterstitialComponentPallette();

  // =============
  @DefaultMessage("GetAllData")
  @Description("")
  String GetAllDataMethods();

  @DefaultMessage("GetColumnData")
  @Description("")
  String GetColumnDataMethods();

  @DefaultMessage("GetRowData")
  @Description("")
  String GetRowDataMethods();

  @DefaultMessage("GetCellData")
  @Description("")
  String GetCellDataMethods();

  @DefaultMessage("PostData")
  @Description("")
  String PostDataMethods();

  @DefaultMessage("GoogleSpreadsheet")
  @Description("")
  String googleSpreadsheetComponentPallette();

  @DefaultMessage("This is a component that allows you to read your Google Spreadsheet data using CloudStitch. " +
          "<p>CloudStitch allows you to setup a project, that links to your Google Spreadsheet. <p>This component allows you to easily " +
          "read / insert Spreadsheet data")
  @Description("")
  String GoogleSpreadsheetHelpStringComponentPallette();

  @DefaultMessage("ApiEndpoint")
  @Description("")
  String ApiEndpointProperties();

  @DefaultMessage("KeyExtension")
  @Description("")
  String KeyExtensionProperties();

  @DefaultMessage("SheetName")
  @Description("")
  String SheetNameProperties();

  @DefaultMessage("AfterGetAllData")
  @Description("")
  String AfterGetAllDataEvents();

//  @DefaultMessage("SheetName")
//  @Description("")
//  String sheetNameProperties();

  @DefaultMessage("AfterUpload")
  @Description("")
  String AfterUploadEvents();

  @DefaultMessage("columnName")
  @Description("")
  String columnNameParams();
  ...
  @DefaultMessage("GetSpreadsheetData")
  @Description("")
  String GetSpreadsheetDataMethods();

  @DefaultMessage("StoreData")
  @Description("")
  String StoreDataMethods();

  @DefaultMessage("dataToStore")
  @Description("")
  String dataToStoreParams();

  @DefaultMessage("placementName")
  @Description("")
  String placementNameParams();

  @DefaultMessage("ThumbColorChecked")
  @Description("")
  String ThumbColorCheckedProperties();

  @DefaultMessage("ThumbColorUnchecked")
  @Description("")
  String ThumbColorUncheckedProperties();

  @DefaultMessage("TrackColorChecked")
  @Description("")
  String TrackColorCheckedProperties();

  @DefaultMessage("TrackColorUnchecked")
  @Description("")
  String TrackColorUncheckedProperties();

  @DefaultMessage("headerImagePath")
  @Description("")
  String headerImagePathParams();
    ...
    // barcode scanner new blocks
    @DefaultMessage("Format")
    @Description("")
    String FormatProperties();

    @DefaultMessage("Scan1DIndustrial")
    @Description("")
    String Scan1DIndustrialProperties();

    @DefaultMessage("Scan1DProduct")
    @Description("")
    String Scan1DProductProperties();

   @DefaultMessage("ScanDataMatrix")
    @Description("")
    String ScanDataMatrixProperties();

   @DefaultMessage("ScanQRCode")
    @Description("")
    String ScanQRCodeProperties();
   ...
   @DefaultMessage("Sidebar")
    @Description("")
    String sidebarComponentPallette();

   @DefaultMessage("Sidebar is a panel that shows your app main navigation menu. " +
           "<p>It is hidden when not in use, but appears when the user swipes a finger from the left edge of the screen. " +
           "<p>You can setup a headerImage and a list of icons from https://fontawesome.com/cheatsheet")
    @Description("")
    String SidebarHelpStringComponentPallette();

   @DefaultMessage("CloseSidebar")
    @Description("")
    String CloseSidebarMethods();

   @DefaultMessage("OpenSidebar")
    @Description("")
    String OpenSidebarMethods();
  ...
  @DefaultMessage("Create")
   ...
   @DefaultMessage("Snackbar")
    @Description("")
    String snackbarComponentPallette();

   @DefaultMessage("Snackbar provide feedback about an operation. It can show a brief message at the bottom of the screen. Snackbars appear above all other elements on screen and only one can be displayed at a time." +
           "<p>Snackbar disappear after user interaction.")
    @Description("")
    String SnackbarHelpStringComponentPallette();
   @DefaultMessage("action1")
    @Description("")
    String action1Params();
  @DefaultMessage("action2")
    @Description("")
    String action2Params();

  @DefaultMessage("Effects")
    @Description("")
    String effectsComponentPallette();



  @DefaultMessage("Decoration")
    @Description("")
    String decorationComponentPallette();

 @DefaultMessage("Decoration is a non-visible component that allows you to change decoration (appearance) (e.g. Padding) of any of the Visible components.")
    @Description("")
    String DecorationHelpStringComponentPallette();

  @DefaultMessage("values")
  @Description("")
  String setPaddingParams();

  @DefaultMessage("values")
  @Description("")
  String setMarginParams();

  @DefaultMessage("SetPadding")
  @Description("")
  String SetPaddingMethods();

  @DefaultMessage("SetMargin")
  @Description("")
  String SetMarginMethods();

  @DefaultMessage("SetShape")
  @Description("")
  String SetShapeMethods();

  @DefaultMessage("backgroundColor")
  @Description("")
  String backgroundColorParams();

  @DefaultMessage("borderColor")
  @Description("")
  String borderColorParams();

  @DefaultMessage("isRound")
  @Description("")
  String isRoundParams();

  // === permissions
  @DefaultMessage("RequestAppPermission")
  @Description("")
  String RequestAppPermissionMethods();

 @DefaultMessage("ArePermissionsGranted")
  @Description("")
  String ArePermissionsGrantedProperties();

  // === gdpr
  @DefaultMessage("IsEuropeanUser")
  @Description("")
  String IsEuropeanUserMethods();

  @DefaultMessage("RequestConsentStatus")
  @Description("")
  String RequestConsentStatusMethods();

  @DefaultMessage("RevokeConsent")
  @Description("")
  String RevokeConsentMethods();

 @DefaultMessage("SetConsent")
  @Description("")
  String SetConsentMethods();

  @DefaultMessage("ConsentStatusLoaded")
  @Description("")
  String ConsentStatusLoadedEvents();

  @DefaultMessage("isPersonalized")
  @Description("")
  String isPersonalizedParams();

  @DefaultMessage("isEuropeanUser")
  @Description("")
  String isEuropeanUserParams();

  @DefaultMessage("SetGradient")
  @Description("")
  String SetGradientMethods();

  //=========== Airtable
  @DefaultMessage("Airtable")
  @Description("")
  String airtableComponentPallette();

  @DefaultMessage("<h4>Non-visible component that provides access to http://Airtable.com Airtable spreadsheet storage.<br />")
  @Description("")
  String AirtableHelpStringComponentPallette();

  @DefaultMessage("BaseId")
  @Description("")
  String BaseIdProperties();

  @DefaultMessage("TableName")
  @Description("")
  String TableNameProperties();

  @DefaultMessage("ViewName")
  @Description("")
  String ViewNameProperties();

  @DefaultMessage("CellChanged")
  @Description("")
  String CellChangedEvents();

  @DefaultMessage("GotColumn")
  @Description("")
  String GotColumnEvents();

  @DefaultMessage("GotRow")
  @Description("")
  String GotRowEvents();

  @DefaultMessage("RowCreated")
  @Description("")
  String RowCreatedEvents();

  @DefaultMessage("RowUpdated")
  @Description("")
  String RowUpdatedEvents();

  @DefaultMessage("CreateRow")
  @Description("")
  String CreateRowMethods();

  @DefaultMessage("DeleteRowNum")
  @Description("")
  String DeleteRowNumMethods();

  @DefaultMessage("GetAllRows")
  @Description("")
  String GetAllRowsMethods();

  @DefaultMessage("GetCell")
  @Description("")
  String GetCellMethods();

  @DefaultMessage("SetCell")
  @Description("")
  String SetCellMethods();

  @DefaultMessage("GetColumn")
  @Description("")
  String GetColumnMethods();

  @DefaultMessage("GetRow")
  @Description("")
  String GetRowMethods();

  @DefaultMessage("UpdateRowByNum")
  @Description("")
  String UpdateRowByNumMethods();

  @DefaultMessage("totalRows")
  @Description("")
  String totalRowsParams();

  @DefaultMessage("rowId")
  @Description("")
  String rowIdParams();

 @DefaultMessage("rowIds")
  @Description("")
  String rowIdsParams();

  @DefaultMessage("createdTimes")
  @Description("")
  String createdTimesParams();

  @DefaultMessage("columnNames")
  @Description("")
  String columnNamesParams();

  @DefaultMessage("maxRecord")
  @Description("")
  String maxRecordParams();

  @DefaultMessage("DeletedRowByNumber")
  @Description("")
  String DeletedRowByNumberEvents();

  @DefaultMessage("GotAllRows")
  @Description("")
  String GotAllRowsEvents();

  @DefaultMessage("GotCell")
  @Description("")
  String GotCellEvents();

  @DefaultMessage("createdTime")
  @Description("")
  String createdTimeParams();

  // ================= api level
  @DefaultMessage("MaxAPI")
  @Description("")
  String MaxAPIProperties();
  ...
  // ========== Gravity sensor
  @DefaultMessage("GravitySensor")
  @Description("")
  String gravitySensorComponentPallette();

  @DefaultMessage("GravityX")
  @Description("")
  String GravityXProperties();

  @DefaultMessage("GravityY")
  @Description("")
  String GravityYProperties();

  @DefaultMessage("GravityZ")
  @Description("")
  String GravityZProperties();

  @DefaultMessage("GravityChanged")
  @Description("")
  String GravityChangedEvents();

  @DefaultMessage("<p>Non-visible component.The gravity sensor provides a three dimensional vector indicating the direction and " +
          "magnitude of gravity. Typically, this sensor is used to determine the device relative orientation in space</p>")
  @Description("")
  String GravitySensorHelpStringComponentPallette();

  // ============== facecbook
  @DefaultMessage("FBInterstitial")
  @Description("")
  String fBInterstitialComponentPallette();
  @DefaultMessage("<p>Non-visible component for monetizing and displaying full screen Facebook ads</p>")
  @Description("")
  String FBInterstitialHelpStringComponentPallette();
  @DefaultMessage("PlacementID")
  @Description("")
  String PlacementIDProperties();
  @DefaultMessage("AdDisplayed")
  @Description("")
  String AdDisplayedEvents();

  // ============ canvas polygon
  @DefaultMessage("DrawPolygon")
  @Description("")
  String DrawPolygonMethods();

  @DefaultMessage("skewX")
  @Description("")
  String skewXParams();

  @DefaultMessage("skewY")
  @Description("")
  String skewYParams();

  @DefaultMessage("drawAngle")
  @Description("")
  String drawAngleParams();

  @DefaultMessage("radiusInner")
  @Description("")
  String radiusInnerParams();

  @DefaultMessage("radiusOuter")
  @Description("")
  String radiusOuterParams();

  @DefaultMessage("points")
  @Description("")
  String pointsParams();

  @DefaultMessage("numSides")
  @Description("")
  String numSidesParams();

  @DefaultMessage("cornerRadius")
  @Description("")
  String cornerRadiusParams();

  @DefaultMessage("rotation")
  @Description("")
  String rotationParams();

  @DefaultMessage("polyRadius")
  @Description("")
  String polyRadiusParams();
