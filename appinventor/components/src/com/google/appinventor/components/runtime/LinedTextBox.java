...
//        int count = (height-paddingTop-paddingBottom) / lineHeight;
                ...
                int count = getLineHeight();
                paddingLeft=0; paddingRight=0;left=0;
                for (int i = 0; i < count; i++) {
                    int baseline = lineHeight * (i+1) + paddingTop;
                    canvas.drawLine(left+paddingLeft, baseline, right-paddingRight, baseline, getPaint());
                }
...
//        mPaint.setColor(0x800000FF);
        ...
        //remove the edittext underline indicator. Don't use xml, because its for ap1 +21: android:backgroundTint="@android:color/transparent"
     ...
     */
    @SimpleFunction(description = "Hide the keyboard.  Only multiline text boxes need this. " +
