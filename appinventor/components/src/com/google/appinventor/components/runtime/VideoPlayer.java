...
@DesignerComponent(
    ...
    description = "A multimedia component capable of playing videos. "
        ...
        + "<p>AppyBuilder for Android only permits video files under 1 MB and "
...
public final class VideoPlayer extends AndroidViewComponent implements
  ...
  @SimpleProperty(description = "Shows / hides the video controller buttons")
  public void ControlsEnabled(boolean enabled) {
