...
public final class YandexTranslate extends AndroidNonvisibleComponent {
  ...
  private String Yandex_API_Key="Yandex_API_Key";
...
//      Yandex_API_Key = "Yandex_API_Key";
    ...
    /**
     * Yandex_API_Key property getter method.
     */
    ...
    /**
     * Yandex_API_Key property setter method: sets the Yandex_API_Key
     *
     * @param Yandex_API_Key
     */
    @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_STRING, defaultValue = "Yandex_API_Key")
    @SimpleProperty(category = PropertyCategory.BEHAVIOR, description="The API Key for image uploading, provided by Yandex." +
            "You can obtain an API key from here: http://api.yandex.com/key/form.xml?service=trnsl")
    public void Yandex_API_Key(String Yandex_API_Key) {
