...
public final class CheckBox extends AndroidViewComponent
  ...
  public CheckBox(ComponentContainer container) {
    ...
    CheckboxColor(Component.COLOR_DKGRAY);
   ...
   */
  @SimpleEvent(description = "Triggered when state of Checkbox changes. Use isChecked to determine if checked or not-checked")
  ...
  @SimpleProperty(description = "Sets up the color of the checkbox NOT the text. Works only if AP is > 21")
  public void CheckboxColor(int argb) {
    if (SdkLevel.getLevel() >= 21) {
//      LollipopUtil.setCheckBoxButtonTintList(this.view, -8205116);
      view.setButtonTintList(ColorStateList.valueOf(argb));
//      view.setButtonTintList(ColorStateList.valueOf(-8572101));  // my color - http://www.colourdetails.com/hex-code/7D333B
    }
  }
