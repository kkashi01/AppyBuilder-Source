...
//  private final MySeekbar seekbar;
  ...
  public Slider(ComponentContainer container) {
    super(container);
//    seekbar = new MySeekbar(container.$context());
      seekbar = new SeekBar(container.$context());

    fullBar = (LayerDrawable) seekbar.getProgressDrawable().getCurrent();
//    beforeThumb = (ClipDrawable) fullBar.findDrawableByLayerId(R.id.progress);
      beforeThumb = new ClipDrawable(((ScaleDrawable) fullBar.findDrawableByLayerId(R.id.progress)).getDrawable(), 3, 1);
//      beforeThumb = ((ClipDrawable) fullBar.findDrawableByLayerId(R.id.progress)
 ...
 private void setSeekbarPosition() {
  ...
  // Chech here. Good options: https://www.androidtutorialpoint.com/basics/android-seekbar-tutorial/
  /**
