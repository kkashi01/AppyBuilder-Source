...
public class PackageInstaller {
  ...
  private static final String LOG_TAG = "PackageInstaller(AB)";
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
        ...
        public void run() {
          try {
            ...
            // Need to check if device has api lower than 24.
            // If yes, then we don't need file provider, otherwise user won't be able to scan qr code to download app from appengine
