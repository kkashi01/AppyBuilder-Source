...
public class FloatingButton extends AndroidNonvisibleComponent implements Component {
  ...
  public FloatingButton(ComponentContainer container) {
    ...
    fabButton = new Builder(context)
            ...
            .withButtonColor(bgcolor)
            .withGravity(Gravity.BOTTOM | Gravity.RIGHT)
            .withButtonSize(container.$form().convertDpToDensity(size))
...
//    intcontainer.$form().addContentView(fabButton);
  ...
  public void ReCreateFAB() {
    ...
    if (backgroundImageDrawable != null) {
      ...
      backgroundImageDrawable = container.$context().getResources(). getDrawable(android.R.drawable.ic_input_add);
    }
    fabButton = new Builder(context)
            .withDrawable(backgroundImageDrawable)
	            .withButtonColor(bgcolor)
            .withGravity(Gravity.BOTTOM | Gravity.RIGHT)
...
//      size =  convertToPixels(size, scale); // default size is 72dp by 72dp
    ...
    public FloatingActionButton create() {
      ...
      if (view == null) {
        ...
        view.setFloatingActionButtonColor(bgcolor);
        view.setFloatingActionButtonDrawable(drawable);
