...
public class YaVersion {
  ...
  // For 23, Bitwise and, ior, and xor blocks were added.
  ...
  // For CANVAS_COMPONENT_VERSION 11:, DrawShape & DrawArc was added
  // For 12, added DrawPolygon
  ...
  // For 24, Screen1.MinAPI and Screen1.MaxAPI were added
  ...
  public static final int GRAVITY_COMPONENT_VERSION = 1;
  ...
  public static final int SPACER_COMPONENT_VERSION = 1;
  ...
  public static final int SNACKBAR_COMPONENT_VERSION = 1;
  ...
  // For WEB_COMPONENT_VERSION 5: Added method UriDecode
  ...
  public static final int ADMOB_INTERSTITIAL_COMPONENT_VERSION = 1;
  public static final int MEMORY_INFO_COMPONENT_VERSION = 1;
  public static final int ADMOB_REWARD_VIDEO_COMPONENT_VERSION = 1;
  public static final int MOBFOX_INTERSTITIAL_COMPONENT_VERSION = 1;
  public static final int MOBFOX_COMPONENT_VERSION = 1;
  public static final int MMEDIA_INTERSTITIAL_COMPONENT_VERSION = 1;
  public static final int ADMOB_COMPONENT_VERSION = 1;
  public static final int FB_BANNER_COMPONENT_VERSION = 1;
  public static final int FB_FULL_COMPONENT_VERSION = 1;
  public static final int AIRTABLE_COMPONENT_VERSION = 1;
  public static final int OFFERWALL_COMPONENT_VERSION = 1;
  public static final int ADAMAZON_COMPONENT_VERSION = 1;
  public static final int BATTERY_STATE_COMPONENT_VERSION = 1;
  public static final int KITCHENSINK_COMPONENT_VERSION = 2;
  public static final int WALLPAPER_COMPONENT_VERSION = 1;
  public static final int NAVIGATION_DRAWER_COMPONENT_VERSION = 1;
  public static final int PRESSURESENSOR_COMPONENT_VERSION = 1;
  public static final int LIGHTSENSOR_COMPONENT_VERSION = 1;
  public static final int MAGNETIC_FIELD_COMPONENT_VERSION = 1;
  public static final int XYCHART_COMPONENT_VERSION = 1;
  public static final int FTP_COMPONENT_VERSION = 1;
  public static final int TEMPERATURESENSOR_COMPONENT_VERSION = 1;
  public static final int GALLERYVIEWER_COMPONENT_VERSION = 1;
  public static final int CHRONOMETER_COMPONENT_VERSION = 1;
  public static final int IN_APP_COMPONENT_VERSION = 1;
  public static final int TOGGLER_COMPONENT_VERSION = 1;
  public static final int WIFI_MANAGER_COMPONENT_VERSION = 1;
  public static final int GOOGLE_MAP_COMPONENT_VERSION = 1;
  public static final int SQLITE_COMPONENT_VERSION = 1;
  public static final int FLOATING_BUTTON_COMPONENT_VERSION = 1;
  public static final int PUSH_NOTIFICATION_COMPONENT_VERSION = 1;
  public static final int GRIDVIEW_COMPONENT_VERSION = 1;
