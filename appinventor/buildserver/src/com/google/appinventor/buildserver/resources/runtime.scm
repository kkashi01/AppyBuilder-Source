...
(define (yail-divide n d)
  ...
  (cond ((and (= d 0) (= n 0))
        ...
        (else
         ...
         ;; rationals, which is simpler for AppyBuilder users.
...
Lists in AppyBuilder are implemented as "Yail lists".  A Yail list is
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;; Communication with non-AppyBuilder apps
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;; Note: There are two methods by which AppyBuilder screens can
...
;; APP_INVENTOR_RESULT.  If App B is an AppyBuilder App, it will see
...
;; can pass the string [ 1, 2, [3, 4]] to an AppyBuilder app that
