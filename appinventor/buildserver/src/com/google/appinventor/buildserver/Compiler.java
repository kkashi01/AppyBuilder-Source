    ...
    private boolean writeAndroidManifest(File manifestFile) {
      ...
      /*if (simpleCompTypes.contains("com.google.appinventor.components.runtime.FirebaseDB") && !isForCompanion) {
        minSDK = LEVEL_GINGERBREAD_MR1;
            ...
            //AdMob, or mmedia or OneSignal
            if (simpleCompTypesString.contains("OneSignalPush") || simpleCompTypesString.contains("GoogleMap") || simpleCompTypesString.contains("AdMob") || simpleCompTypesString.contains("RewardedVideo")
            ...
            //AdAmazon
            if (simpleCompTypesString.contains("AdAmazon") || simpleCompTypesString.contains("AdAmazonInterstitial" ) || isForCompanion) {
            ...
            //MMedia
            if (simpleCompTypesString.contains("MMediaInterstitial") || simpleCompTypesString.contains("MMedia") ) {
                out.write("<activity android:name=\"com.millennialmedia.android.MMActivity\" android:configChanges=\"keyboardHidden|orientation|screenSize\" />");
            }

            //Facebook
            if (simpleCompTypesString.contains("FacebookInterstitial") ) {
                out.write("<activity android:name=\"com.facebook.ads.InterstitialAdActivity\" android:configChanges=\"keyboardHidden|orientation\" />");
            }
